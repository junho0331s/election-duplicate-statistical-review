...
| `outputs/objection_coverage_audit.json` | JSON objection-coverage audit summary | Machine-readable verification of coverage for one-duplicate, 2014 inclusion, three-versus-five, look-elsewhere, heterogeneity, self-selection, rare-event, official-file, and benign-alternative objections. | `status`, `check_count`, `scope`, `checks` |
...
| `outputs/pre_submission_audit.json` | JSON audit summary | Machine-readable result of the 16 pre-submission audit checks. | `status`, `check_count`, `scope`, `checks` |
