...
| `outputs/objection_coverage_audit.json` | JSON objection-coverage audit summary | Machine-readable verification of coverage for one-duplicate, 2014 inclusion, three-versus-five, look-elsewhere, heterogeneity, self-selection, rare-event, official-file, benign-alternative, chain-of-custody raw-record objections, and the post-disclosure decision tree. | `status`, `check_count`, `scope`, `checks` |
