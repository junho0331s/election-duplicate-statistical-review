...
| `outputs/claim_boundary_audit.json` | JSON claim-boundary audit summary | Machine-readable verification of overclaim absence, falsifiability language, and raw-record requirements in manuscripts, memos, and PDFs. | `status`, `check_count`, `scope`, `checks` |
