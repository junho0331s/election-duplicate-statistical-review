...
| `outputs/video_source_exclusion_audit.json` | JSON video-source exclusion audit summary | Machine-readable verification that 23 manuscript-facing files contain no informal video-platform URLs or subtitle-dependence markers. | `status`, `check_count`, `checked_files`, `failures` |
