...
SCRIPTS = [
    ...
    "verify_public_discussion_claims.py",
...
def main() -> None:
    ...
    expected = [
        ...
        ROOT / "outputs" / "probability_designated_pairs.csv",
        ...
        ROOT / "outputs" / "public_discussion_claims_audit.csv",
        ROOT / "outputs" / "public_discussion_claims_audit.json",
        ...
        ROOT / "outputs" / "submission_index_audit.csv",
        ROOT / "outputs" / "submission_index_audit.json",
