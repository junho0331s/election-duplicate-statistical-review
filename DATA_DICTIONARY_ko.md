...
| `outputs/objection_coverage_audit.json` | JSON 반론 커버리지 감사 요약 | 한 쌍 반론, 2014 포함, 3쌍 대 5쌍, 사후탐색, 이질성, 자기선택, 드문 사건, 공식파일 한계, 대안 설명, 인수인계 원자료 요구, 원자료 공개 후 판정 트리 반론의 커버리지 검증 | `status`, `check_count`, `scope`, `checks` |
