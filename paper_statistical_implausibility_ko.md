# 우연가설을 압도하는 관내사전투표 동일 득표쌍 반복: 2026년 지방선거 통계적 이상치와 원자료 감사 요구
...
본 논문은 2026년 6월 3일 실시된 제9회 전국동시지방선거에서 관찰된 관내사전투표 동일 득표쌍 반복 현상이 우연가설로 설명 가능한지를 검토한다. 분석의 출발점은 공개 보도에서 제기된 "전국 12곳", 그중 "광주전남 10개 지역"의 1·2위 후보 동일 득표 사례이며, 본 연구는 이 12개 사건값을 중앙선거관리위원회 선거통계시스템의 개표단위별 개표결과 HTML에서 직접 추출해 대조했다. 광주전남 사례는 같은 선거, 같은 후보 조합, 같은 투표유형 안에서 5개의 동일 득표쌍이 반복된 경우로 정의된다. 본 연구는 2014년부터 2025년까지 중앙선거관리위원회 및 공공데이터포털 공개자료 81,701개 사전투표 개표단위 행을 파싱해 과거 기준선을 만들고, 특히 시·도지사 선거의 실제 1·2위 후보 득표쌍 반복 빈도를 경험적으로 추정했다. 그 결과 2014·2018·2022년 시·도지사 선거 51개 선거구, 약 1,514,172개 비교쌍에서 동일 득표쌍은 15개였고, 한 선거구 안에서 관찰된 최대 반복은 3쌍이었다. 이 확장 기준선으로 2026년 광주전남에서 5쌍 이상이 나타날 확률은 포아송 근사에서 약 0.115%로 추정된다. 별도로, 관찰된 광주전남 5개 대응쌍을 지정 대응쌍으로 둘 때 5개가 모두 일치할 조건부 확률은 같은 \(K=100,944.8\) 기준에서 약 \(9.54\times10^{-26}\), 즉 약 \(1.05\times10^{25}\)번에 1번이다. 또한 과거 시·도지사 실제 득표쌍 풀에서 393개를 비복원 재표본추출한 200,000회 검정에서는 5쌍 이상 반복이 0회였고, 95% 상한은 약 0.0015%였다. 2016·2020·2024년 국회의원선거 공식 개표자료를 이용해 사전투표와 선거일 당일투표의 양자득표율 차이를 검산한 결과, 2020년과 2024년에는 분석 가능한 모든 지역구에서 더불어민주당 후보의 사전투표 양자득표율이 당일투표보다 높게 나타났다. 본 연구의 결론은 특정 부정행위의 법적 확정이 아니라, 공개자료만으로도 우연가설을 약화시키는 통계적 이상성이 존재하며 독립적 원자료 감사가 필요하다는 것이다.

주요어: 관내사전투표, 동일 득표쌍, 선거무결성, 중복확률, 포아송 근사, 사전투표 편차, 원자료 감사
...
1. 같은 선거, 같은 후보 조합, 같은 관내사전투표 유형에서 1·2위 후보 득표쌍이 5쌍 이상 반복되는 현상은 과거 자료에서 얼마나 자주 관찰되었는가?
2. 단순 중복확률 모형에서 이러한 반복은 어느 정도의 확률로 발생하는가?
3. 이 현상은 단순 우연으로 처리할 수 있는가, 아니면 원자료 검증을 요구하는 통계적 이상치인가?
...
- 귀무가설 \(H_0\): 2026년 광주전남 관내사전투표에서 관찰된 1·2위 후보 동일 득표쌍 5쌍은 과거 시·도지사 선거에서 관찰된 동일 득표쌍 발생 구조와 양립한다. 쉽게 말해, 과거 자료로 볼 때 충분히 나올 수 있는 사건이라는 가정이다.
- 대립가설 \(H_1\): 2026년 광주전남 관내사전투표의 동일 득표쌍 5쌍은 과거 시·도지사 선거의 경험분포와 양립하기 어려운 이상치이다. 쉽게 말해, 과거 자료로는 설명하기 어려운 사건이라는 가정이다.

2차 검정은 사전투표와 선거일 당일투표의 득표율 차이에 관한 것이다.

- 귀무가설 \(H_0'\): 사전투표와 당일투표의 득표율 차이는 선거구별 유권자 선택과 일반적 투표행태 차이의 범위 안에서 설명된다.
- 대립가설 \(H_1'\): 사전투표와 당일투표의 득표율 차이는 다수 선거구에서 같은 방향으로 반복되며, 추가 설명변수 또는 원자료 검증 없이는 충분히 설명되지 않는다.
...
- 선거: 2026년 제9회 전국동시지방선거
- 투표유형: 관내사전투표
- 비교 대상: 같은 광역단체장 선거 안의 읍면동 단위 개표 결과
- 후보 기준: 해당 선거의 주요 1·2위 후보
- 사건: 서로 다른 두 개표단위에서 1위 후보 득표수와 2위 후보 득표수가 동시에 동일함
...
- 광주전남 내부 사건: 같은 선거 안 5쌍
- 전국 보도 사건: 서로 다른 선거를 포함한 6쌍
...
2026년 지방선거 공식 통합 XLSX 개표자료는 본 원고 작성 시점의 공공데이터포털 검색에서 기준선 자료와 같은 방식으로 확보되지 않았다. 그러나 중앙선거관리위원회 선거통계시스템의 "개표단위별 개표결과" 화면은 제9회 전국동시지방선거 결과를 제공하고 있었으며, 본 연구는 해당 화면의 POST 응답 HTML을 저장·파싱해 12개 사건값을 재확인했다. 이 절차는 `scripts/fetch_nec_2026_duplicate_cases.py`에 구현되어 있고, 산출물은 `outputs/nec_2026_reported_duplicate_cases.csv`와 `outputs/nec_2026_reported_duplicate_pairs.csv`이다. 따라서 2026년 사건값은 더 이상 보도 화면에만 의존하지 않는다. 다만 통합 XLSX 파일 또는 개표상황표 원본이 공개되면 같은 사건 정의로 추가 재검산해야 한다.
...
1. 같은 선거, 같은 선거종류, 같은 선거구, 같은 투표유형으로 개표단위를 묶는다.
2. 해당 묶음 안에서 후보별 총득표를 계산한다.
3. 총득표 기준 실제 1위와 2위 후보를 선정한다.
4. 각 읍면동 관내사전투표 개표단위에서 이 두 후보의 득표쌍을 만든다.
5. 같은 득표쌍이 두 개 이상 개표단위에서 반복되는지 계산한다.
...
1. 2026년 12개 사건행은 중앙선거관리위원회 선거통계시스템 공식 화면값에서 재현된다.
2. 이 12개 사건행은 6개의 동일 득표쌍을 이룬다.
3. 과거 시·도지사 관내사전투표 51개 선거구에서 한 선거구 안 최대 반복은 3쌍이다.
4. 광주전남 5쌍 반복의 포아송 근사 꼬리확률은 \(N=393, K=100,944.8\) 기준 약 0.115%이다.
5. 과거 시·도지사 실제 득표쌍 풀에서 393개 개표단위를 비복원 재표본추출한 200,000회 검정에서 5쌍 이상 반복은 한 번도 나타나지 않았다.
6. 2020·2024 총선에서 민주당 후보의 사전투표 양자득표율은 분석 가능한 모든 지역구에서 당일투표보다 높았다.

반대로 아직 현재 자료만으로 확정되지 않는 명제는 "동일성이 자연적 개표 과정에서 발생했는지, 입력·표시 오류인지, 다른 원인인지"이다. 이 원인 명제는 개표상황표 원본, 1차 분류기 결과, 재확인표 배분 내역, 입력 로그가 있어야 판단할 수 있다. 각 명제와 재현 파일의 상세 대응은 제출 패키지의 `evidence_matrix_ko.md`에 따로 정리했다.
...
본 연구는 이 \(N\)을 행정구역 근사가 아니라 중앙선거관리위원회 선거통계시스템 VCCP08 공식 HTML에서 직접 센 값으로 둔다. 광주광역시 5개 구와 전라남도 22개 시군의 시·도지사선거 개표단위별 개표결과를 모두 파싱한 뒤, `관내사전투표`이면서 `합계`가 아닌 행만 세었다. 그 결과 `outputs/nec_2026_gwangju_jeonnam_unit_counts.csv`에서 광주 96개, 전남 297개, 합계 393개 관내사전 개표단위가 확인된다. 따라서 본문 계산의 기준값은 \(N=393\)이다.
...
### 5.3 지정된 5개 대응쌍이 모두 일치할 조건부 확률

앞의 \(P(C \geq 5)\)는 광주전남 393개 개표단위 안에서 어떤 단위 조합이든 동일 득표쌍 5쌍 이상이 생기는지를 묻는 넓은 사건정의이다. 이와 별도로, 실제 관찰된 광주전남 5개 대응쌍을 사전에 지정된 대응쌍으로 두고 각 대응쌍이 모두 같은 득표쌍으로 일치할 조건부 확률을 계산할 수 있다. 같은 경험적 \(K=100,944.8\)을 쓰면 지정된 한 대응쌍이 일치할 확률은 \(1/K\)이고, 5개 대응쌍이 모두 일치할 확률은 다음과 같다.

\[
\left(\frac{1}{100,944.8}\right)^5 \approx 9.54 \times 10^{-26}
\]

역수로 쓰면 약 \(1.05\times 10^{25}\)번에 1번 수준이다. 이 값은 `outputs/probability_designated_pairs.csv`에 기록된다. 따라서 본 연구는 두 확률을 구분한다. \(P(C \geq 5)\)는 넓은 공간에서 5개 이상 충돌이 생기는 주검정이고, \((1/K)^5\)는 관찰된 5개 대응쌍을 사전 지정 대응쌍으로 볼 때의 조건부 계산이다. 두 계산은 사건정의가 다르지만, 둘 다 광주전남 5쌍 반복이 평범한 우연이라고 보기 어렵다는 같은 방향의 신호를 준다.

### 5.4 정확 pair-collision 계산
...
### 5.7 경험적 비복원 재표본추출 검정

포아송 근사는 해석이 간단하지만, "가능한 득표쌍 범위 \(K\)"라는 모형 가정을 포함한다. 따라서 본 연구는 모형 의존성을 줄이기 위해 과거 시·도지사 관내사전투표의 실제 1·2위 득표쌍 풀을 직접 재표본추출했다.

절차는 다음과 같다.

1. 2014·2018·2022년 시·도지사 관내사전투표에서 실제 1·2위 후보 득표쌍 10,322개를 모은다.
2. 이 중 393개 개표단위를 비복원으로 무작위 추출한다.
3. 추출 표본 안에서 동일 득표쌍이 몇 개 그룹 반복되는지 센다.
4. 이 절차를 고정 난수시드로 200,000회 반복한다.
...
공개 논의에서 자주 언급되는 2022년 대선 대구 서구 비산1동 제3·제4투표소 사례도 이 구분을 보여준다. 본 연구가 `data/pres2022.xlsx`를 검산한 결과 두 투표소는 실제로 이재명 131표, 윤석열 618표로 같았다. 그러나 이 사례는 대통령선거 선거일 투표구의 한 쌍 사례이고, 본 연구의 핵심 사건은 지방선거 시·도지사 관내사전투표 읍면동 개표단위에서 같은 후보 조합 5쌍이 반복된 사건이다. 따라서 비산1동 사례는 "한 쌍은 과거에도 있었다"는 반론을 정직하게 인정하게 해주지만, 광주전남 5쌍 검정에 합산하거나 그 결론을 무효화하는 근거는 아니다.
...
1. 매우 낮은 확률의 우연
2. 개표상황표 작성 또는 전산 입력 오류
3. 공개 시스템 표시 오류
4. 재확인표 처리 과정의 체계적 쏠림
5. 실제 부정행위
...
1. 12곳 전체의 개표상황표 원본
2. 각 개표단위의 1차 투표지분류기 후보별 결과
3. 재확인 대상 투표지 수
4. 재확인 대상 투표지의 후보별 최종 배분 내역
5. 무효표, 기권표, 제3후보 득표수
6. 개표부서, 분류기, 심사·집계부, 입력자, 시간대 로그
7. 선관위 전산 공개값과 개표상황표 원본의 대조 결과
8. 정당·후보자 추천 참관인의 이의제기 여부
...
1. 사전투표와 당일투표의 차이가 여러 선거구에서 같은 정당 방향으로 반복된다.
2. 차이가 과거 같은 지역의 사전-당일 차이보다 갑자기 커진다.
3. 연령, 성별, 지역, 도시·농촌, 사전투표율 등 설명 가능한 요인을 반영해도 남는 차이가 크다.
4. 관내사전투표와 관외사전투표의 패턴이 서로 다르게 나타난다.
5. 동일 득표쌍 반복, 투표용지 부족, 개표상황표 불일치 같은 별도 이상치와 같은 지역·같은 선거에서 겹친다.
...
둘째, 2020년과 2024년의 패턴은 2016년보다 훨씬 강하다. 2020년에는 분석 가능한 236개 지역구 전부에서 민주당 사전 우위가 나타났고, 2024년에도 245개 지역구 전부에서 민주당 사전 우위가 나타났다. 평균 차이도 약 10~11%p로 확대되었다.
...
1. 인천 송도1동·송도2동의 동일 득표쌍은 관내사전투표에서 발생했다.
2. 광주전남 10개 지역, 즉 5쌍의 동일 득표쌍도 관내사전투표에서 발생했다.
3. 과거 시·도지사 공식자료에서 한 선거구 안 동일 득표쌍 최대 관측값은 3쌍이었다.
4. 6.3 지방선거 보도 사례는 같은 선거구 안 5쌍으로, 확장 기준선의 과거 최대치를 초과한다.
5. 2020·2024 총선에서도 사전투표는 당일투표와 체계적으로 다른 방향성을 보였다.
...
### 12.1 "개표단위가 많으면 같은 득표쌍은 언제든 나올 수 있다"
...
### 12.3 "과거에도 3쌍이 있었다면 5쌍도 큰 차이가 아니다"
...
### 12.4 "읍면동 규모와 지역 성향이 다르므로 단순 확률계산이 틀릴 수 있다"
...
### 12.5 "전국 12곳은 나중에 찾아낸 사례이므로 확률을 그대로 볼 수 없다"
...
### 12.6 "2026년 자료가 아직 공식 통합 파일이 아니라 언론 보도 기반이다"

이 반론은 초기 초안에는 타당했지만, 현재 원고에는 그대로 적용되지 않는다. 본 연구는 2026년 12개 사건행을 중앙선거관리위원회 선거통계시스템의 개표단위별 개표결과 HTML에서 직접 추출했다. 재현 스크립트 `scripts/fetch_nec_2026_duplicate_cases.py`는 선거ID `0020260603`, 메뉴 `VCCP08`, 선거종류 `시·도지사선거`를 POST 조회하고, 관내사전투표 행에서 후보별 득표수를 파싱한다. 그 결과 `outputs/nec_2026_reported_duplicate_cases.csv`에는 12개 사건행이, `outputs/nec_2026_reported_duplicate_pairs.csv`에는 6개 동일 득표쌍이 생성된다.
...
### 12.7 "사전투표와 당일투표 차이는 유권자가 스스로 선택한 결과일 수 있다"
...
### 12.8 "통계적으로 드문 사건은 실제로도 가끔 발생한다"
...
### 12.9 "이 주장은 어떻게 반증될 수 있는가"

본 연구의 주장은 반증 가능하다. 다음 중 하나가 확인되면 결론은 약화되거나 철회되어야 한다.

1. 2026년 12곳의 동일 득표쌍 보도값이 공식 개표상황표 원본과 다르다.
2. 광주전남 5쌍이 같은 선거구·같은 후보 조합·같은 관내사전투표 유형이 아니었다.
3. 2014·2018·2022년 외의 동일 제도권 시·도지사 관내사전투표 자료에서 한 선거구 안 5쌍 이상 반복 사례가 다수 확인된다.
...
본 연구의 과거 기준선 분석은 공개된 중앙선거관리위원회 및 공공데이터포털 자료에 기초한다. 분석에 사용한 원자료 파일, 파싱 스크립트, 확률 계산 스크립트, 출력 CSV는 본 제출 패키지 안에 정리했다. 핵심 산출물은 `README.md`의 재현 절차에 따라 다시 생성할 수 있다.

2026년 지방선거 동일 득표쌍 사건값은 중앙선거관리위원회 선거통계시스템의 개표단위별 개표결과 HTML에서 직접 추출한 값으로 대조했다. 원본 HTML 캐시는 `data/nec_2026_official_html/`에, 파싱 결과는 `outputs/nec_2026_reported_duplicate_cases.csv`와 `outputs/nec_2026_reported_duplicate_pairs.csv`에 포함했다. 다만 공공데이터포털의 공식 통합 XLSX 개표자료 또는 개표상황표 원본이 공개되면, 본 연구의 스크립트를 동일하게 적용해 사건값과 반복 수를 추가 재검산해야 한다.
...
- TV조선. 2026.06.08. "인천·전남 등 전국 12곳서 '동일 득표' 잇따라...'우연의 일치' 해명에도 논란 확산." https://news.tvchosun.com/site/data/html_dir/2026/06/08/2026060890338.html
- 뉴스1/다음. 2026.06.06. "송도1동과 송도2동 표 수가 왜 똑같아?...박찬대·유정복 득표 논란." https://v.daum.net/v/20260606113452062
- 한겨레. 2026.06.08. "'송도1·2동, 박찬대·유정복 같은 득표수'에 선관위 '부정개표 없어'." https://www.hani.co.kr/arti/area/capital/1262526.html
- 공공데이터포털. 중앙선거관리위원회_제6회 전국동시지방선거 개표결과_20140604. https://www.data.go.kr/data/15048207/fileData.do
- 공공데이터포털. 중앙선거관리위원회_투·개표 정보. https://www.data.go.kr/data/15000900/openapi.do
- 중앙선거관리위원회 국가선거정보 개방포털. 국회의원·대통령·전국동시지방선거 개표결과 공개자료. https://data.nec.go.kr/
- 공공데이터포털. 중앙선거관리위원회 선거 개표결과 파일데이터. https://www.data.go.kr/
- 공공데이터포털. 광주광역시_주민센터 현황. https://www.data.go.kr/data/3082663/fileData.do
- 전라남도청. 전남소개 일반현황 행정구역. https://www.jeonnam.go.kr/contentsView.do?menuId=jeonnam0602030000

## 재현 산출물

- 의존성 파일: `requirements.txt`
- 전체 재현 스크립트: `scripts/run_all.py`
- 분석 스크립트: `scripts/analyze_duplicates.py`
- 시·도지사 실제 1·2위 기준선 스크립트: `scripts/analyze_governor_actual_top2.py`
- 시·도지사 비복원 재표본추출 스크립트: `scripts/bootstrap_governor_duplicates.py`
- 확률 및 민감도 표 재현 스크립트: `scripts/probability_sensitivity.py`
- 사전-당일 검산 스크립트: `scripts/analyze_early_day_assembly.py`
- 추가 원자료: `data/local2014.xlsx`
- 기존 요약표: `outputs/duplicate_summary.csv`
- 중복 그룹: `outputs/duplicate_groups.csv`
- 중복 사례: `outputs/duplicate_examples.csv`
- 시·도지사 실제 1·2위 기준선 요약: `outputs/governor_actual_top2_summary.csv`
- 시·도지사 선거구별 기준선: `outputs/governor_actual_top2_by_contest.csv`
- 시·도지사 동일 득표쌍 사례: `outputs/governor_actual_top2_duplicates.csv`
- 시·도지사 비복원 재표본추출 요약: `outputs/governor_bootstrap_summary.csv`
- 시·도지사 비복원 재표본추출 히스토그램: `outputs/governor_bootstrap_histogram.csv`
- 핵심 확률표: `outputs/probability_core.csv`
- 가능한 득표쌍 범위 민감도 표: `outputs/probability_k_sensitivity.csv`
- 개표단위 수 민감도 표: `outputs/probability_n_sensitivity.csv`
- 사전-당일 검산 요약: `outputs/early_day_assembly_summary.csv`
- 사전-당일 지역구별 결과: `outputs/early_day_assembly_twoparty.csv`
- 본 논문: `paper_statistical_implausibility_ko.md`
- IEIE LaTeX 원고: `latex/ieie/main.tex`
- IEIE PDF 원고: `latex/ieie/main.pdf`
