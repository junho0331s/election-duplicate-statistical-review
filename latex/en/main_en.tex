...
This calculation uses official National Assembly counting files and is reproducible through \path{scripts/analyze_early_day_assembly.py}. The 2016 result does not show a uniform direction. The 2020 and 2024 results do. This makes the pattern difficult to dismiss as ordinary sampling noise alone.
